                ...
                <div class="col-sm-12">
                    <div class="box-authentication" style="text-align: center">
                        ...
                        <div class="input-group">
						  ...
						  <span class="input-group-addon2" id="basic-addon1">الاسم الاول</span>
						...
						<div class="input-group">
						  ...
						  <span class="input-group-addon2" id="basic-addon1">الاسم الاخير</span>
						...
						<div class="input-group">
						  <span class="input-group-addon2" >الجنس</span>
						  <select style="text-indent: " name="gender" class="form-control">
                        ...
                        <div class="input-group">
						  <span class="input-group-addon2" >اسم المستخدم</span>
                        ...
                        <div class="input-group">
						  ...
						  <span class="input-group-addon2" id="basic-addon1">البريد الالكتروني</span>
						...
						<!--<div class="input-group">
						  ...
						  <span class="input-group-addon2" id="basic-addon1">تأكيد البريد الالكتروني</span>
