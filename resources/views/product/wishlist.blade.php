            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list" style="z-index: 2 !important;">
                    <h2 class="page-heading">
                        <span class="page-heading-title" style="direction: rtl;">قائمة المفضلة</span>
                    </h2>
                    ...
                    <!-- ./PRODUCT LIST -->
                    @else
                    <div style="    width: 90%;margin: 50px;text-align: center;">عفوا .. لايوجد لديك منتجات في قائمة المفضلة .. برجاء اختيار المنتجات المفضلة </div>
