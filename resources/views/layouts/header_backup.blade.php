...
<div id="header" class="header">
    <div class="top-header">
        <div class="container">
            ...
            <div class="social-link social-top hidden-xs" style="display: inline;">
            ...
            <div id="user-info-top" class="user-info pull-right">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu mega_dropdown" role="menu">
                        @if(!\Auth::check())
                        <li><a href="/login" onclick="location.href='/login';">تسجيل الدخول</a></li>
                        @else
                        <li><a style="direction: rtl;" href="/profile" onclick="location.href='/profile';">تفاصيل الحساب ({{ \Auth::user()->fname }})</a></li>
                        <li><a style="direction: rtl;" href="/myOrders" onclick="location.href='/myOrders';">قائمة المشتريات</a></li>
                        <li><a style="direction: rtl;" href="/myAddress" onclick="location.href='/myAddress';">عناوين الشحن</a></li>
                        @endif
                        <li><a href="/compare" onclick="location.href='/compare';">مقارنة المنتجات</a></li>
                        <li><a href="/wishlist" onclick="location.href='/wishlist';">قائمة التمنيات</a></li>
                        @if(\Auth::check())
                        	<li><a href="/logout" onclick="location.href='/logout';">تسجيل الخروج</a></li>
                        @endif
                    </ul>
                </div>
            </div>
